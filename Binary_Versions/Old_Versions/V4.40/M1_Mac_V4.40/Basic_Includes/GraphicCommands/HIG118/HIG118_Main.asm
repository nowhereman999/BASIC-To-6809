; Graphics commands for screen mode HIG118
; Resolution of 128x192x16 colours
ScreenWidth_HIG118    EQU 128
ScreenHeight_HIG118   EQU 192
BytesPerRow_HIG118    EQU ScreenWidth_HIG118/2
Screen_Size_HIG118    EQU $3000
;
; Do SET
; Enter with:
...
DoSet_HIG118:
        ...
        LDB     1,S
        ANDB    #%00000001
        BNE     SetOddPixel_HIG118 ; Go colour the Odd Pixel
; Set the even pixel
        LDA     #%00001111
...
GCLS_HIG118:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG118,X ; Screen Size
        STU     GCLSComp_HIG118+1 ; Self mod end address
        ANDB    #%00001111
        PSHS    B  
        LSLB
        LSLB
