...
Character_Blank:
        CLRA
        STA     ,U                      * 0
        STA     BytesPerRow_HIG150,U      * 1
        STA     BytesPerRow_HIG150*2,U    * 2
        LEAU    BytesPerRow_HIG150*6,U
        STA     -BytesPerRow_HIG150*3,U   * 3
        STA     -BytesPerRow_HIG150*2,U   * 4
        STA     -BytesPerRow_HIG150,U     * 5
        STA     ,U                      * 6
        STA     BytesPerRow_HIG150,U      * 7
        STA     BytesPerRow_HIG150*2,U    * 8
        STA     BytesPerRow_HIG150*3,U    * 9
        RTS
; **************************************
;  !
;0 00000000
...
Character_Exclamation:
        CLRA
        STA     ,U                      * 0
        LEAU    BytesPerRow_HIG150*5,U
        STA     BytesPerRow_HIG150,U      * 6
        STA     BytesPerRow_HIG150*3,U    * 8
        STA     BytesPerRow_HIG150*4,U    * 9
        LDA     #%00001000
        STA     -BytesPerRow_HIG150*4,U   * 1
        STA     -BytesPerRow_HIG150*3,U   * 2
        STA     -BytesPerRow_HIG150*2,U   * 3
        STA     -BytesPerRow_HIG150,U     * 4
        STA     ,U                      * 5
        STA     BytesPerRow_HIG150*2,U    * 7
        RTS
; **************************************
;  "
;0 00000000
...
Character_Quote:
        CLRA
        STA     ,U     * 0
        LEAU    BytesPerRow_HIG150*4,U
        STA     ,U     * 4      U
        STA     BytesPerRow_HIG150,U   * 5
        STA     BytesPerRow_HIG150*2,U   * 6
        STA     BytesPerRow_HIG150*3,U   * 7
        STA     BytesPerRow_HIG150*4,U   * 8
        STA     BytesPerRow_HIG150*5,U   * 9
        LDA     #%00010100
        STA     -BytesPerRow_HIG150*3,U  * 1
        STA     -BytesPerRow_HIG150*2,U  * 2
        STA     -BytesPerRow_HIG150,U  * 3
        RTS
; **************************************
;  #
;0 00000000
