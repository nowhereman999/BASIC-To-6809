; Graphics commands for screen mode HIG117
; Resolution of 128x225x4 colours
ScreenWidth_HIG117    EQU 128
ScreenHeight_HIG117   EQU 225
BytesPerRow_HIG117    EQU ScreenWidth_HIG117/4
Screen_Size_HIG117    EQU $1C20
;
; Do SET
; Enter with:
...
DoSet_HIG117:
        ...
        LDX     #PixelTable0_HIG117 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG117 ; U points to the table of pixel values
        LSLB
...
POINT_HIG117:
        ...
        LDX     #PixelTableClear_HIG117 ; X points to the table of pixel values
...
GCLS_HIG117:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG117,X ; Screen Size
        STU     GCLSComp_HIG117+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
