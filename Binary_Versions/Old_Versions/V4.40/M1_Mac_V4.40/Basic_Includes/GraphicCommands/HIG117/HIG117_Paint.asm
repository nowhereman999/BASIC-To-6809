...
PaintWhileLoop1_HIG117:           ; Start of WHILE/WEND loop
        ...
        BEQ     PaintWend_01_HIG117    ; If Equal, then jump to the end of the WHILE/WEND loop
...
PaintWhileLoop3_HIG117                ; Start of WHILE/WEND loop
        ...
        BHS     PaintWend_03_HIG117   ; If the result is a false then goto the end of the WHILE/WEND loop
        ...
        BNE     PaintWend_03_HIG117  ; If they are not equal then goto the end of the WHILE/WEND loop
