; Graphics commands for screen mode HIG128
; Resolution of 160x200x16 colours
ScreenWidth_HIG128    EQU 160
ScreenHeight_HIG128   EQU 200
BytesPerRow_HIG128    EQU ScreenWidth_HIG128/2
Screen_Size_HIG128    EQU $3E80
;
; SET a dot on screen
; Enter with:
; A = y coordinate
...
DoSet_HIG128:
        ...
        LDB     1,S
        ANDB    #%00000001
        BNE     SetOddPixel_HIG128 ; Go colour the Odd Pixel
; Set the even pixel
        LDA     #%00001111
...
GCLS_HIG128:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG128,X ; Screen Size
        STU     GCLSComp_HIG128+1 ; Self mod end address
        ANDB    #%00001111
        PSHS    B  
        LSLB
        LSLB
