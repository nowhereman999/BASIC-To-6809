; Graphics commands for screen mode HIG124
; Resolution of 160x192x4 colours
ScreenWidth_HIG124    EQU 160
ScreenHeight_HIG124   EQU 192
BytesPerRow_HIG124    EQU ScreenWidth_HIG124/4
Screen_Size_HIG124    EQU $1E00
;
; Enter with:
; A = y coordinate
; B = x coordinate
...
DoSet_HIG124:
        ...
        LDX     #PixelTable0_HIG124 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG124 ; U points to the table of pixel values
        LSLB
...
POINT_HIG124:
        ...
        LDX     #PixelTableClear_HIG124 ; X points to the table of pixel values
...
GCLS_HIG124:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG124,X ; Screen Size
        STU     GCLSComp_HIG124+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
