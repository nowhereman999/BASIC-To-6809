; Graphics commands for screen mode HIG157
; Resolution of 640x192x4 colours
ScreenWidth_HIG157    EQU 640
ScreenHeight_HIG157   EQU 192
BytesPerRow_HIG157    EQU ScreenWidth_HIG157/4
Screen_Size_HIG157    EQU $7800
;
; Enter with:
; A = y coordinate
; X = x coordinate
...
DoSet_HIG157:
        ...
        LDX     #PixelTable0_HIG157 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG157 ; U points to the table of pixel values
        LSLB
...
POINT_HIG157:
        ...
        LDU     #PixelTableClear_HIG157 ; U points to the table of pixel values
...
GCLS_HIG157:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG157,X ; Screen Size
        STU     GCLSComp_HIG157+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
