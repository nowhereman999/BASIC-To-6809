; Graphics commands for screen mode HIG102
; Resolution of 64x225x4 colours
ScreenWidth_HIG102    EQU 64
ScreenHeight_HIG102   EQU 225
BytesPerRow_HIG102    EQU ScreenWidth_HIG102/4
Screen_Size_HIG102    EQU $0E10
;
; Do SET
; Enter with:
...
DoSet_HIG102:
        ...
        LDX     #PixelTable0_HIG102 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG102 ; U points to the table of pixel values
        LSLB
...
POINT_HIG102:
        ...
        LDX     #PixelTableClear_HIG102 ; X points to the table of pixel values
...
GCLS_HIG102:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG102,X ; Screen Size
        STU     GCLSComp_HIG102+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
