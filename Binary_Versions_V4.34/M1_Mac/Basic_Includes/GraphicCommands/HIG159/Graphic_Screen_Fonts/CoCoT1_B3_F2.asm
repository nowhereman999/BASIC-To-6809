...
Character_Blank:
        ...
        STD     ,U                      * 0
        STD     BytesPerRow_HIG159,U      * 1
        STD     BytesPerRow_HIG159*2,U    * 2
        LEAU    BytesPerRow_HIG159*6,U
        STD     -BytesPerRow_HIG159*3,U   * 3
        STD     -BytesPerRow_HIG159*2,U   * 4
        STD     -BytesPerRow_HIG159,U     * 5
        STD     ,U                      * 6
        STD     BytesPerRow_HIG159,U      * 7
        STD     BytesPerRow_HIG159*2,U    * 8
        STD     BytesPerRow_HIG159*3,U    * 9
        RTS
; **************************************
; !
;0 0000000000000000
...
Character_Exclamation:
        LDD     #%1111111111111111
        STD     ,U                      * 0
        LEAU    BytesPerRow_HIG159*5,U
        STD     BytesPerRow_HIG159,U      * 6
        STD     BytesPerRow_HIG159*3,U    * 8
        STD     BytesPerRow_HIG159*4,U    * 9
        LDD     #%1111111011111111
        STD     -BytesPerRow_HIG159*4,U   * 1
        STD     -BytesPerRow_HIG159*3,U   * 2
        STD     -BytesPerRow_HIG159*2,U   * 3
        STD     -BytesPerRow_HIG159,U     * 4
        STD     ,U                      * 5
        STD     BytesPerRow_HIG159*2,U    * 7
        RTS
; **************************************
; "
;0 0000000000000000
...
Character_Quote:
        LDD     #%1111111111111111
        STD     ,U     * 0
        LEAU    BytesPerRow_HIG159*4,U
        STD     ,U     * 4      U
        STD     BytesPerRow_HIG159,U   * 5
        STD     BytesPerRow_HIG159*2,U   * 6
        STD     BytesPerRow_HIG159*3,U   * 7
        STD     BytesPerRow_HIG159*4,U   * 8
        STD     BytesPerRow_HIG159*5,U   * 9
        LDD     #%1111101110111111
        STD     -BytesPerRow_HIG159*3,U  * 1
        STD     -BytesPerRow_HIG159*2,U  * 2
        STD     -BytesPerRow_HIG159,U  * 3
        RTS
; **************************************
; #
;0 0000000000000000
...
Character_DollarSign:
        ...
        STD     -BytesPerRow_HIG159*3,U  * 1
        STD     BytesPerRow_HIG159*3,U   * 7
        LDD     #%1111101010101111
        STD     -BytesPerRow_HIG159*2,U  * 2
        LDD     #%1110111111111111
        STD     -BytesPerRow_HIG159,U  * 3
        LDD     #%1111101010111111
        STD     ,U     * 4      U
        LDD     #%1111111111101111
        STD     BytesPerRow_HIG159,U   * 5
        LDD     #%1110101010111111
        STD     BytesPerRow_HIG159*2,U   * 6
        RTS
; **************************************
; %
...
Character_Percent:
        ...
        STD     BytesPerRow_HIG159*4,U   * 8
        STD     BytesPerRow_HIG159*5,U   * 9
        LDD     #%1110101111111111
        STD     -BytesPerRow_HIG159*3,U  * 1
        LDD     #%1110101111101111
        STD     -BytesPerRow_HIG159*2,U  * 2
        LDD     #%1111111110111111
        STD     -BytesPerRow_HIG159,U  * 3
        LDD     #%1111111011111111
        STD     ,U     * 4      U
        LDD     #%1111101111111111
        STD     BytesPerRow_HIG159,U   * 5
        LDD     #%1110111110101111
        STD     BytesPerRow_HIG159*2,U   * 6
        LDD     #%1111111110101111
        STD     BytesPerRow_HIG159*3,U   * 7
        RTS
; **************************************
; &
...
Character_Ampersand:
        ...
        STD     -BytesPerRow_HIG159*3,U  * 1
        STD     ,U     * 4      U
        LDD     #%1110111011111111
        STD     -BytesPerRow_HIG159*2,U  * 2
        LDD     #%1110111011111111
        STD     -BytesPerRow_HIG159,U  * 3
        LDD     #%1110111011101111
        STD     BytesPerRow_HIG159,U   * 5
        LDD     #%1110111110111111
        STD     BytesPerRow_HIG159*2,U   * 6
        LDD     #%1111101011101111
        STD     BytesPerRow_HIG159*3,U   * 7
        RTS
; **************************************
; '
