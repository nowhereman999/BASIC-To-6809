; Graphics commands for screen mode HIG100
; Resolution of 64x192x4 colours
ScreenWidth_HIG100    EQU 64
ScreenHeight_HIG100   EQU 192
BytesPerRow_HIG100    EQU ScreenWidth_HIG100/4
Screen_Size_HIG100    EQU $0C00
;
; Do SET
; Enter with:
...
DoSet_HIG100:
        ...
        LDX     #PixelTable0_HIG100 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG100 ; U points to the table of pixel values
        LSLB
...
POINT_HIG100:
        ...
        LDX     #PixelTableClear_HIG100 ; X points to the table of pixel values
...
GCLS_HIG100:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG100,X ; Screen Size
        STU     GCLSComp_HIG100+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
