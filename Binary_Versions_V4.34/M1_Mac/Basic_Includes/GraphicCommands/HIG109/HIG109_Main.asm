; Graphics commands for screen mode HIG109
; Resolution of 80x192x16 colours
ScreenWidth_HIG109    EQU 80
ScreenHeight_HIG109   EQU 192
BytesPerRow_HIG109    EQU ScreenWidth_HIG109/2
Screen_Size_HIG109    EQU $1E00
;
; Do SET
; Enter with:
...
DoSet_HIG109:
        ...
        LDB     1,S
        ANDB    #%00000001
        BNE     SetOddPixel_HIG109 ; Go colour the Odd Pixel
; Set the even pixel
        LDA     #%00001111
...
GCLS_HIG109:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG109,X ; Screen Size
        STU     GCLSComp_HIG109+1 ; Self mod end address
        ANDB    #%00001111
        PSHS    B  
        LSLB
        LSLB
