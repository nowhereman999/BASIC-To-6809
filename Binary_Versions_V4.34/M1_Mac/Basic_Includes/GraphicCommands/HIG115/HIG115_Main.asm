; Graphics commands for screen mode HIG115
; Resolution of 128x192x4 colours
ScreenWidth_HIG115    EQU 128
ScreenHeight_HIG115   EQU 192
BytesPerRow_HIG115    EQU ScreenWidth_HIG115/4
Screen_Size_HIG115    EQU $1800
;
; Do SET
; Enter with:
...
DoSet_HIG115:
        ...
        LDX     #PixelTable0_HIG115 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG115 ; U points to the table of pixel values
        LSLB
...
POINT_HIG115:
        ...
        LDX     #PixelTableClear_HIG115 ; X points to the table of pixel values
...
GCLS_HIG115:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG115,X ; Screen Size
        STU     GCLSComp_HIG115+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
