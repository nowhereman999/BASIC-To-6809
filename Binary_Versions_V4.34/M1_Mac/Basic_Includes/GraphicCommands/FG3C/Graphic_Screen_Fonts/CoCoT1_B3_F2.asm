...
Character_Blank:
        ...
        STD     ,U                      * 0
        STD     BytesPerRow_FG3C,U      * 1
        STD     BytesPerRow_FG3C*2,U    * 2
        LEAU    BytesPerRow_FG3C*6,U
        STD     -BytesPerRow_FG3C*3,U   * 3
        STD     -BytesPerRow_FG3C*2,U   * 4
        STD     -BytesPerRow_FG3C,U     * 5
        STD     ,U                      * 6
        STD     BytesPerRow_FG3C,U      * 7
        STD     BytesPerRow_FG3C*2,U    * 8
        STD     BytesPerRow_FG3C*3,U    * 9
        RTS
; **************************************
; !
;0 0000000000000000
...
Character_Exclamation:
        LDD     #%1111111111111111
        STD     ,U                      * 0
        LEAU    BytesPerRow_FG3C*5,U
        STD     BytesPerRow_FG3C,U      * 6
        STD     BytesPerRow_FG3C*3,U    * 8
        STD     BytesPerRow_FG3C*4,U    * 9
        LDD     #%1111111011111111
        STD     -BytesPerRow_FG3C*4,U   * 1
        STD     -BytesPerRow_FG3C*3,U   * 2
        STD     -BytesPerRow_FG3C*2,U   * 3
        STD     -BytesPerRow_FG3C,U     * 4
        STD     ,U                      * 5
        STD     BytesPerRow_FG3C*2,U    * 7
        RTS
; **************************************
; "
;0 0000000000000000
...
Character_Quote:
        LDD     #%1111111111111111
        STD     ,U     * 0
        LEAU    BytesPerRow_FG3C*4,U
        STD     ,U     * 4      U
        STD     BytesPerRow_FG3C,U   * 5
        STD     BytesPerRow_FG3C*2,U   * 6
        STD     BytesPerRow_FG3C*3,U   * 7
        STD     BytesPerRow_FG3C*4,U   * 8
        STD     BytesPerRow_FG3C*5,U   * 9
        LDD     #%1111101110111111
        STD     -BytesPerRow_FG3C*3,U  * 1
        STD     -BytesPerRow_FG3C*2,U  * 2
        STD     -BytesPerRow_FG3C,U  * 3
        RTS
; **************************************
; #
;0 0000000000000000
