...
Character_Blank:
        ...
        STD     -BytesPerRow_HIG119*3,U
        STD     -BytesPerRow_HIG119*3+2,U  * 1
        STD     -BytesPerRow_HIG119*2,U
        STD     -BytesPerRow_HIG119*2+2,U  * 2
        STD     -BytesPerRow_HIG119,U
        STD     -BytesPerRow_HIG119+2,U  * 3
        STD     ,U
        STD     2,U    * 4
        STD     BytesPerRow_HIG119,U
        STD     BytesPerRow_HIG119+2,U   * 5
        STD     BytesPerRow_HIG119*2,U
        STD     BytesPerRow_HIG119*2+2,U   * 6
        STD     BytesPerRow_HIG119*3,U
        STD     BytesPerRow_HIG119*3+2,U   * 7
        RTS
; **************************************
; !
;0 0000000000000000 0000000000000000
