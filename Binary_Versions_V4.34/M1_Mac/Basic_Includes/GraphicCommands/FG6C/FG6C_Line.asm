...
; Test for a horizontal line
        ...
        BNE     LineNotHorizontal_FG6C  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        BEQ     LineDrawDot1_FG6C    ; If zero then go PSET one single pixel
...
!       LDB     endX+1
        ...
        BLS     LineNotHorizontal_FG6C  ; If the size is <= 8 then go draw the line normally
