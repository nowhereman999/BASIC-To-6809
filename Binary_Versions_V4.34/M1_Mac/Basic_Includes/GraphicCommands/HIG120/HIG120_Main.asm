; Graphics commands for screen mode HIG120
; Resolution of 128x225x16 colours
ScreenWidth_HIG120    EQU 128
ScreenHeight_HIG120   EQU 225
BytesPerRow_HIG120    EQU ScreenWidth_HIG120/2
Screen_Size_HIG120    EQU $3840
;
; Do SET
; Enter with:
...
DoSet_HIG120:
        ...
        LDB     1,S
        ANDB    #%00000001
        BNE     SetOddPixel_HIG120 ; Go colour the Odd Pixel
; Set the even pixel
        LDA     #%00001111
...
GCLS_HIG120:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG120,X ; Screen Size
        STU     GCLSComp_HIG120+1 ; Self mod end address
        ANDB    #%00001111
        PSHS    B  
        LSLB
        LSLB
