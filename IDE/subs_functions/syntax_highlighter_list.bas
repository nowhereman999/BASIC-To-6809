...
"AUDIO@BUTTON@CMPEQ@CMPGE@CMPGT@CMPLE@CMPLT@CMPNE@"+_
"" +_
""
...
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"FLOATADD@FLOATATAN@FLOATCOS@FLOATDIV@FLOATEXP@FLOATLOG@FLOATMUL@FLOATSIN@FLOATSQR@FLOATSUB@FLOATTAN@FLOATTOSTR@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (G to L)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"GCLS@GCOPY@GETJOYD@GMODE@JOYSTK@LOADM@"+_
"" +_
""
...
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"SAMPLE_LOAD@SDC_BIGLOADM@SDC_CLOSE@SDC_DELETE@SDC_DIRPAGE@SDC_FILEINFO$@SDC_GETBYTE@SDC_GETBYTE0@SDC_GETBYTE1@SDC_GETCURDIR$@SDC_INITDIR@SDC_LOADM@SDC_MKDIR@SDC_OPEN@SDC_PLAY@SDC_PLAYORCL@SDC_PLAYORCR@SDC_PLAYORCS@SDC_PUTBYTE0@SDC_PUTBYTE1@SDC_SAVEM@SDC_SETDIR@SDC_SETPOS@SET@SPRITE@SPRITE_LOAD@STRTOFLOAT@"+_
"" +_
""
