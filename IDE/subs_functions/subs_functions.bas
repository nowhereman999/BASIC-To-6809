...
' ignore QB64 wait command, so we will use CoCo version
'    clearid
'    id.n = "Wait"
'    id.subfunc = 2
...
'    regid
    ...
    'id.specialformat = "[#]?,[?],?" 'non filed compliant definition
    id.specialformat = "[#]?[,[?][,?]]" 'filed compliant definition
...
' Ignore QB64 VIEW command so the CoCo version will be used
'    clearid
'    id.n = "View"
'    id.subfunc = 2
...
' My New coco commands
    ...
    id.arg = MKL$(LONGTYPE - ISPOINTER)
    id.ret = LONGTYPE - ISPOINTER
    id.hr_syntax = "BUTTON(segment_offset)"
    regid
    ...
    id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?"
    id.hr_syntax = "GCOPY SourcePage, DestinationPage"
    regid
    ...
    id.arg = MKL$(LONGTYPE - ISPOINTER)
    id.ret = LONGTYPE - ISPOINTER
    id.hr_syntax = "JOYSTK(segment_offset)"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?[,?]"
    id.hr_syntax = "LOADM fileName$[,load_offset)]"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?"
    id.hr_syntax = "SAMPLE_LOAD fileName$,Sample #"
    regid
    ...
    id.arg = MKL$(LONGTYPE - ISPOINTER)
    id.ret = LONGTYPE - ISPOINTER
    id.hr_syntax = "SDC_GETBYTE(File # 0 or 1)"
    regid
    ...
    id.arg = MKL$(-1)
    id.ret = STRINGTYPE - ISPOINTER
    id.hr_syntax = "SDC_GETCURDIR$(number)"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER)
    id.ret = FLOATTYPE - ISPOINTER
    id.hr_syntax = "SDC_INITDIR(fileName$)"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?[,?]"
    id.hr_syntax = "SDC_LOADM fileName$,#[,load_offset)]"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER)
    id.ret = FLOATTYPE - ISPOINTER
    id.hr_syntax = "SDC_MKDIR(fileName$)"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?"
    id.hr_syntax = "SDC_PLAY fileName$, File # 0 or 1"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?"
    id.hr_syntax = "SDC_PLAYORCL fileName$, File # 0 or 1"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?"
    id.hr_syntax = "SDC_PLAYORCR fileName$, File # 0 or 1"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?"
    id.hr_syntax = "SDC_PLAYORCS fileName$, File # 0 or 1"
    regid
    ...
    id.arg = MKL$(LONGTYPE - ISPOINTER) 
    id.specialformat = "?"
    id.hr_syntax = "SDC_PUTBYTE0 variable"
    regid
    ...
    id.arg = MKL$(LONGTYPE - ISPOINTER) 
    id.specialformat = "?"
    id.hr_syntax = "SDC_PUTBYTE1 variable"
    regid
    ...
    id.callname = "sub_bload"
    id.args = 5
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?,?,?,?"
    id.hr_syntax = "SDC_SAVEM fileName$,#,Start,End,Exec"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER)
    id.ret = FLOATTYPE - ISPOINTER
    id.hr_syntax = "SDC_SETDIR(fileName$)"
    regid
    ...
    id.args = 2
    id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "{LOOP|SINGLE|STOP}?"
    id.hr_syntax = "SAMPLE LOOP|SINGLE|STOP #"
    regid
    ...
    id.args = 4
    id.arg = MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "{ON|OFF|LOCATE|SHOW|BACKUP|ERASE}?[,?][,?]"
    id.hr_syntax = "SPRITE ON|OFF|LOCATE|SHOW|BACKUP|ERASE #[,?][,?]"
    regid
    ...
    id.arg = MKL$(STRINGTYPE - ISPOINTER) + MKL$(LONGTYPE - ISPOINTER)
    id.specialformat = "?,?"
    id.hr_syntax = "SPRITE_LOAD fileName$,Sprite #"
    regid
