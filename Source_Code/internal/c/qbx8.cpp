...
#include "../temp8/global.txt"
#include "../temp8/regsf.txt"
...
#include "../temp8/maindata.txt"
#include "../temp8/mainerr.txt"
#include "../temp8/runline.txt"
    if (timer_event_occurred) {
        timer_event_occurred--;
#include "../temp8/ontimerj.txt"
    }
    if (key_event_occurred) {
        key_event_occurred--;
#include "../temp8/onkeyj.txt"
    }
    if (strig_event_occurred) {
        strig_event_occurred--;
#include "../temp8/onstrigj.txt"
    }
    chain_input();
    libqb_log_info("QB64 code starting.");

#include "../temp8/main.txt"
