...
"PAINT@PALETTE@PALETTEV@PALETTEW@PCOPY@PEEK@PEN@PLAY@PMAP@POINT@POKE@POS@PRESET@?@PRINT@PSET@PUT@" +_
...
"TAB@TAN@THEN@TIME$@TO@TROFF@TRON@TYPE@" +_
...
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"ATTR@AUDIO@BUTTON@CMP@COCOHARDWARE@DELETE@DIRLIST$@DIRPAGE@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (COCOMP3 commands)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"@COCOMP3_RAW@COCOMP3_AUDIO_MODE@COCOMP3_COMBINATION_PLAY_SETTING@COCOMP3_CYCLE_MODE_SETTING@COCOMP3_END_COMBINATION_PLAY"+_
"@COCOMP3_END_PLAYING@COCOMP3_GET_CURRENT_TRACK@COCOMP3_GET_FOLDER_DIR_TRACK@COCOMP3_GET_TRACKS_IN_FOLDER"+_
"@COCOMP3_GET_NUMBER_OF_TRACKS@COCOMP3_GET_DRIVE_STATUS@COCOMP3_GET_PLAY_STATUS@COCOMP3_NEXT@COCOMP3_PAUSE@COCOMP3_PLAY"+_
"@COCOMP3_PLAY_NEXT_FOLDER@COCOMP3_PLAY_PREVIOUS_FOLDER@COCOMP3_PLAY_TRACK_NUMBER@COCOMP3_PLAY_TRACK@COCOMP3_PREVIOUS"+_
"@COCOMP3_SELECT_BUT_NO_PLAY@COCOMP3_SET_CYCLE_TIMES@COCOMP3_SET_EQ@COCOMP3_SET_PATH_INTERLUDE@COCOMP3_SET_TRACK_INTERLUDE"+_
"@COCOMP3_SET_VOL@COCOMP3_STOP@COCOMP3_TEST@COCOMP3_VOL_DOWN@COCOMP3_VOL_FADE@COCOMP3_VOL_MAX@COCOMP3_VOL_UP@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (A to E)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"COPYBLOCKS@CPUSPEED@EXEC@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (F)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"FILEINFO$@FNADAPTER$@FNAPPKEYCLOSE@FNAPPKEYREAD$@FNAPPKEYSET@FNAPPKEYWRITE@FNBASE64DECODE$@FNBASE64ENCODE$@FNBYTESWAITING@FNCHANNELERROR@FNCHDIR@FNCLOSEDIR@FNCLOSE@FNCONNECTED@FNDELETE@FNDEVICEHOST@FNDEVICEMODE@FNDEVICEPATH$@" +_
"FNDIROPEN@FNDIRPOS@FNERROR@FNHASH$@FNHASHADD@FNHASHCALC$@FNHASHCLEAR@FNHOST$@FNHOSTPREFIX$@FNHTTPDELETE@FNHTTPHEADER@FNHTTPMODE@FNHTTPPOST@FNHTTPPUT@FNINIT@FNJSONPARSE@FNJSONQUERY$@FNLOCK@" +_
"FNMKDIR@FNMOUNTALL@FNMOUNTHOST@FNMOUNTIMAGE@FNOPENDIR@FNOPEN@FNPASSWORD@FNREADDIR$@FNREADMEM@FNREAD$@FNRENAME@FNRMDIR@FNSETDEVICE@FNSETDIRPOS@FNSETHOST@FNSETHOSTPREFIX@FNSETWIFI@FNTIME$@FNUNLOCK@FNUNMOUNTHOST@FNUNMOUNTIMAGE@FNUSERNAME@" +_
"FNWIFIENABLED@FNWIFIRSSI@FNWIFISCAN@FNWIFISSID$@FNWIFISTATUS@FNWRITEMEM@FNWRITE@" +_
"" +_
""

' [CoCo BASIC to 6809 commands] (G to L)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"GCLS@GCOPY@GETBYTE@GETJOYD@GMODE@INITDIR@JOYSTK@LPEEK@LPOKE@LOADM@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (M to R)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"MOTOR@PLAYFIELD@POINT@PUTBYTE0@PUTBYTE1@RGB@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (S)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"SAMPLE_LOAD@SAVEM@SDC_BIGLOADM@SDC_CHAIN@SDC_CLOSE@SDC_DELETE@SDC_DIRLIST$@SDC_DIRPAGE@SDC_FILEINFO$@SDC_GETBYTE@SDC_GETBYTE0@SDC_GETBYTE1@SDC_GETCURDIR$@SDC_INITDIR@SDC_LOADM@SDC_LOF@SDC_MKDIR@SDC_OPEN@SDC_PLAYMOVIE@SDC_PLAY@SDC_PLAYORCL@SDC_PLAYORCR@SDC_PLAYORCS@SDC_PUTBYTE0@SDC_PUTBYTE1@SDC_SAVEM@SDC_SETDIR@SDC_SETPOS@SETPOS0@SETPOS1@SET@SPRITE@SPRITE_LOAD@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (T to Z)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"VIEW@"+_
"" +_
""
