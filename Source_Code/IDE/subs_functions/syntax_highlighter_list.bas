...
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"GCLS@GCOPY@GETJOYD@GMODE@JOYSTK@LPEEK@LPOKE@LOADM@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (M to R)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"MOTOR@PLAYFIELD@POINT@RGB@"+_
"" +_
""

' [CoCo BASIC to 6809 commands] (S)
listOfCustomKeywords$ = listOfCustomKeywords$ +_
"SAMPLE_LOAD@SDC_BIGLOADM@SDC_CLOSE@SDC_DELETE@SDC_DIRLIST$@SDC_DIRPAGE@SDC_FILEINFO$@SDC_GETBYTE@SDC_GETBYTE0@SDC_GETBYTE1@SDC_GETCURDIR$@SDC_INITDIR@SDC_LOADM@SDC_MKDIR@SDC_OPEN@SDC_PLAYMOVIE@SDC_PLAY@SDC_PLAYORCL@SDC_PLAYORCR@SDC_PLAYORCS@SDC_PUTBYTE0@SDC_PUTBYTE1@SDC_SAVEM@SDC_SETDIR@SDC_SETPOS@SET@SPRITE@SPRITE_LOAD@"+_
"" +_
""
