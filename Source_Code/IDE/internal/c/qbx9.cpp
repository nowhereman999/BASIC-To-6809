...
#include "../temp9/global.txt"
#include "../temp9/regsf.txt"
...
#include "../temp9/maindata.txt"
#include "../temp9/mainerr.txt"
#include "../temp9/runline.txt"
    if (timer_event_occurred) {
        timer_event_occurred--;
#include "../temp9/ontimerj.txt"
    }
    if (key_event_occurred) {
        key_event_occurred--;
#include "../temp9/onkeyj.txt"
    }
    if (strig_event_occurred) {
        strig_event_occurred--;
#include "../temp9/onstrigj.txt"
    }
    chain_input();
    libqb_log_info("QB64 code starting.");

#include "../temp9/main.txt"
