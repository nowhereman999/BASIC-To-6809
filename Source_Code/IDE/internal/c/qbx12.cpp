...
#include "../temp12/global.txt"
#include "../temp12/regsf.txt"
...
#include "../temp12/maindata.txt"
#include "../temp12/mainerr.txt"
#include "../temp12/runline.txt"
    if (timer_event_occurred) {
        timer_event_occurred--;
#include "../temp12/ontimerj.txt"
    }
    if (key_event_occurred) {
        key_event_occurred--;
#include "../temp12/onkeyj.txt"
    }
    if (strig_event_occurred) {
        strig_event_occurred--;
#include "../temp12/onstrigj.txt"
    }
    chain_input();
    libqb_log_info("QB64 code starting.");

#include "../temp12/main.txt"
