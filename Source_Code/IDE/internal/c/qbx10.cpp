...
#include "../temp10/global.txt"
#include "../temp10/regsf.txt"
...
#include "../temp10/maindata.txt"
#include "../temp10/mainerr.txt"
#include "../temp10/runline.txt"
    if (timer_event_occurred) {
        timer_event_occurred--;
#include "../temp10/ontimerj.txt"
    }
    if (key_event_occurred) {
        key_event_occurred--;
#include "../temp10/onkeyj.txt"
    }
    if (strig_event_occurred) {
        strig_event_occurred--;
#include "../temp10/onstrigj.txt"
    }
    chain_input();
    libqb_log_info("QB64 code starting.");

#include "../temp10/main.txt"
