...
#include "../temp11/global.txt"
#include "../temp11/regsf.txt"
...
#include "../temp11/maindata.txt"
#include "../temp11/mainerr.txt"
#include "../temp11/runline.txt"
    if (timer_event_occurred) {
        timer_event_occurred--;
#include "../temp11/ontimerj.txt"
    }
    if (key_event_occurred) {
        key_event_occurred--;
#include "../temp11/onkeyj.txt"
    }
    if (strig_event_occurred) {
        strig_event_occurred--;
#include "../temp11/onstrigj.txt"
    }
    chain_input();
    libqb_log_info("QB64 code starting.");

#include "../temp11/main.txt"
