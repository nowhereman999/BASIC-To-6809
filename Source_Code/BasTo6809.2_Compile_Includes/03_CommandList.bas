...
LPEEK_CMD=ii
Check$ = "FNINIT": GoSub FindNumCommandNumber ' Gets the Numeric Command number of Check$, returns with number in ii, Found=1 if found and Found=0 if not found
FNINIT_CMD = ii
Check$ = "FNERROR": GoSub FindNumCommandNumber
FNERROR_CMD = ii
Check$ = "FNWIFISTATUS": GoSub FindNumCommandNumber
FNWIFISTATUS_CMD = ii
Check$ = "FNOPEN": GoSub FindNumCommandNumber
FNOPEN_CMD = ii
Check$ = "FNCLOSE": GoSub FindNumCommandNumber
FNCLOSE_CMD = ii
Check$ = "FNBYTESWAITING": GoSub FindNumCommandNumber
FNBYTESWAITING_CMD = ii
Check$ = "FNCHANNELERROR": GoSub FindNumCommandNumber
FNCHANNELERROR_CMD = ii
Check$ = "FNCONNECTED": GoSub FindNumCommandNumber
FNCONNECTED_CMD = ii
Check$ = "FNWRITE": GoSub FindNumCommandNumber
FNWRITE_CMD = ii
Check$ = "FNJSONPARSE": GoSub FindNumCommandNumber
FNJSONPARSE_CMD = ii
Check$ = "FNWIFIENABLED": GoSub FindNumCommandNumber
FNWIFIENABLED_CMD = ii
Check$ = "FNWIFISCAN": GoSub FindNumCommandNumber
FNWIFISCAN_CMD = ii
Check$ = "FNWIFIRSSI": GoSub FindNumCommandNumber
FNWIFIRSSI_CMD = ii
Check$ = "FNSETWIFI": GoSub FindNumCommandNumber
FNSETWIFI_CMD = ii
Check$ = "FNSETHOST": GoSub FindNumCommandNumber
FNSETHOST_CMD = ii
Check$ = "FNMOUNTHOST": GoSub FindNumCommandNumber
FNMOUNTHOST_CMD = ii
Check$ = "FNUNMOUNTHOST": GoSub FindNumCommandNumber
FNUNMOUNTHOST_CMD = ii
Check$ = "FNDEVICEHOST": GoSub FindNumCommandNumber
FNDEVICEHOST_CMD = ii
Check$ = "FNDEVICEMODE": GoSub FindNumCommandNumber
FNDEVICEMODE_CMD = ii
Check$ = "FNSETDEVICE": GoSub FindNumCommandNumber
FNSETDEVICE_CMD = ii
Check$ = "FNMOUNTIMAGE": GoSub FindNumCommandNumber
FNMOUNTIMAGE_CMD = ii
Check$ = "FNUNMOUNTIMAGE": GoSub FindNumCommandNumber
FNUNMOUNTIMAGE_CMD = ii
Check$ = "FNMOUNTALL": GoSub FindNumCommandNumber
FNMOUNTALL_CMD = ii
Check$ = "FNSETHOSTPREFIX": GoSub FindNumCommandNumber
FNSETHOSTPREFIX_CMD = ii
Check$ = "FNOPENDIR": GoSub FindNumCommandNumber
FNOPENDIR_CMD = ii
Check$ = "FNCLOSEDIR": GoSub FindNumCommandNumber
FNCLOSEDIR_CMD = ii
Check$ = "FNDIRPOS": GoSub FindNumCommandNumber
FNDIRPOS_CMD = ii
Check$ = "FNSETDIRPOS": GoSub FindNumCommandNumber
FNSETDIRPOS_CMD = ii
Check$ = "FNAPPKEYSET": GoSub FindNumCommandNumber
FNAPPKEYSET_CMD = ii
Check$ = "FNAPPKEYWRITE": GoSub FindNumCommandNumber
FNAPPKEYWRITE_CMD = ii
Check$ = "FNAPPKEYCLOSE": GoSub FindNumCommandNumber
FNAPPKEYCLOSE_CMD = ii
Check$ = "FNHASHCLEAR": GoSub FindNumCommandNumber
FNHASHCLEAR_CMD = ii
Check$ = "FNHASHADD": GoSub FindNumCommandNumber
FNHASHADD_CMD = ii
Check$ = "FNHTTPMODE": GoSub FindNumCommandNumber
FNHTTPMODE_CMD = ii
Check$ = "FNHTTPHEADER": GoSub FindNumCommandNumber
FNHTTPHEADER_CMD = ii
Check$ = "FNHTTPPOST": GoSub FindNumCommandNumber
FNHTTPPOST_CMD = ii
Check$ = "FNHTTPPUT": GoSub FindNumCommandNumber
FNHTTPPUT_CMD = ii
Check$ = "FNHTTPDELETE": GoSub FindNumCommandNumber
FNHTTPDELETE_CMD = ii
Check$ = "FNREADMEM": GoSub FindNumCommandNumber
FNREADMEM_CMD = ii
Check$ = "FNWRITEMEM": GoSub FindNumCommandNumber
FNWRITEMEM_CMD = ii
Check$ = "FNDELETE": GoSub FindNumCommandNumber
FNDELETE_CMD = ii
Check$ = "FNRENAME": GoSub FindNumCommandNumber
FNRENAME_CMD = ii
Check$ = "FNLOCK": GoSub FindNumCommandNumber
FNLOCK_CMD = ii
Check$ = "FNUNLOCK": GoSub FindNumCommandNumber
FNUNLOCK_CMD = ii
Check$ = "FNMKDIR": GoSub FindNumCommandNumber
FNMKDIR_CMD = ii
Check$ = "FNRMDIR": GoSub FindNumCommandNumber
FNRMDIR_CMD = ii
Check$ = "FNCHDIR": GoSub FindNumCommandNumber
FNCHDIR_CMD = ii
Check$ = "FNDIROPEN": GoSub FindNumCommandNumber
FNDIROPEN_CMD = ii
Check$ = "FNUSERNAME": GoSub FindNumCommandNumber
FNUSERNAME_CMD = ii
Check$ = "FNPASSWORD": GoSub FindNumCommandNumber
FNPASSWORD_CMD = ii
...
DIRLIST_CMD = ii
Check$ = "FNREAD$": GoSub FindStrCommandNumber
FNREAD_CMD = ii
Check$ = "FNJSONQUERY$": GoSub FindStrCommandNumber
FNJSONQUERY_CMD = ii
Check$ = "FNWIFISSID$": GoSub FindStrCommandNumber
FNWIFISSID_CMD = ii
Check$ = "FNADAPTER$": GoSub FindStrCommandNumber
FNADAPTER_CMD = ii
Check$ = "FNHOST$": GoSub FindStrCommandNumber
FNHOST_CMD = ii
Check$ = "FNDEVICEPATH$": GoSub FindStrCommandNumber
FNDEVICEPATH_CMD = ii
Check$ = "FNHOSTPREFIX$": GoSub FindStrCommandNumber
FNHOSTPREFIX_CMD = ii
Check$ = "FNREADDIR$": GoSub FindStrCommandNumber
FNREADDIR_CMD = ii
Check$ = "FNTIME$": GoSub FindStrCommandNumber
FNTIME_CMD = ii
Check$ = "FNAPPKEYREAD$": GoSub FindStrCommandNumber
FNAPPKEYREAD_CMD = ii
Check$ = "FNHASH$": GoSub FindStrCommandNumber
FNHASH_CMD = ii
Check$ = "FNHASHCALC$": GoSub FindStrCommandNumber
FNHASHCALC_CMD = ii
Check$ = "FNBASE64ENCODE$": GoSub FindStrCommandNumber
FNBASE64ENCODE_CMD = ii
Check$ = "FNBASE64DECODE$": GoSub FindStrCommandNumber
FNBASE64DECODE_CMD = ii
