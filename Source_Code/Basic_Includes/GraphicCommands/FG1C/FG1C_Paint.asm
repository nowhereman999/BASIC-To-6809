...
PaintWhileLoop1_FG1C:           ; Start of WHILE/WEND loop
        ...
        LBEQ    PaintWend_01_FG1C    ; If Equal, then jump to the end of the WHILE/WEND loop
...
PaintWhileLoop3_FG1C                ; Start of WHILE/WEND loop
        ...
        LBHS    PaintWend_03_FG1C   ; If the result is a false then goto the end of the WHILE/WEND loop
        ...
        LBNE    PaintWend_03_FG1C  ; If they are not equal then goto the end of the WHILE/WEND loop
