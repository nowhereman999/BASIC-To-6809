...
; Test for a horizontal line
        ...
        BNE     LineNotHorizontal_HIG108  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        BEQ     LineDrawDot1_HIG108    ; If zero then go PSET one single pixel
...
!       LDB     endX+1
        ...
        BLS     LineNotHorizontal_HIG108  ; If the size is <= 8 then go draw the line normally
