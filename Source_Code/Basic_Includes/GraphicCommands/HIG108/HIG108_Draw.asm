...
DrawDestination         FCB     112,40        ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     112,40        ; y,x co-ordinates of the Draw Start
...
DrawHIG108:
        ...
        LDY     #LINE_HIG108    ; Y points at the routine to draw the line
