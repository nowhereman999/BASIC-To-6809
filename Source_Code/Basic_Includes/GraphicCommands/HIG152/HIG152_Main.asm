; Graphics commands for screen mode HIG152
; Resolution of 512x200x4 colours
ScreenWidth_HIG152    EQU 512
ScreenHeight_HIG152   EQU 200
BytesPerRow_HIG152    EQU ScreenWidth_HIG152/4
Screen_Size_HIG152    EQU $6400
;
; Enter with:
; A = y coordinate
; X = x coordinate
...
DoSet_HIG152:
        ...
        LDX     #PixelTable0_HIG152 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG152 ; U points to the table of pixel values
        LSLB
...
POINT_HIG152:
        ...
        LDU     #PixelTableClear_HIG152 ; U points to the table of pixel values
...
GCLS_HIG152:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG152,X ; Screen Size
        STU     GCLSComp_HIG152+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
