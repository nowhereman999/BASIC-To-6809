...
; Test for a horizontal line
        ...
        BNE     LineNotHorizontal_HIG152  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        BEQ     LineDrawDot1_HIG152    ; If zero then go SET one single pixel
...
!       LDD     endX
        SUBD    startX          ;
        CMPD    #8             
        BLS     LineNotHorizontal_HIG152  ; If the size is <= 8 then go draw the line normally
