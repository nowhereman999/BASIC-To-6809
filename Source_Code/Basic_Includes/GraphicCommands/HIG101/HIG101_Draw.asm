...
DrawDestination         FCB     100,32         ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     100,32         ; y,x co-ordinates of the Draw Start
...
NoUpdateStart:
        LDY     #LINE_HIG101    ; Y points at the routine to draw the line
