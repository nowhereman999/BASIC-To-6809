; Graphics commands for screen mode HIG153
; Resolution of 512x225x4 colours
ScreenWidth_HIG153    EQU 512
ScreenHeight_HIG153   EQU 225
BytesPerRow_HIG153    EQU ScreenWidth_HIG153/4
Screen_Size_HIG153    EQU $7080
;
; Enter with:
; A = y coordinate
; X = x coordinate
...
POINT_HIG153:
        ...
        LDU     #PixelTableClear_HIG153 ; U points to the table of pixel values
...
GCLS_HIG153:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG153,X ; Screen Size
        STU     GCLSComp_HIG153+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
