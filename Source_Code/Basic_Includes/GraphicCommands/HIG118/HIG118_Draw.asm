...
DrawDestination         FCB     96,64         ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     96,64         ; y,x co-ordinates of the Draw Start
...
DrawHIG118:
        ...
        LDY     #LINE_HIG118    ; Y points at the routine to draw the line
