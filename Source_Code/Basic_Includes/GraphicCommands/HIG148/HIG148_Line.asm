...
; Test for a horizontal line
        ...
        LBNE    LineNotHorizontal_HIG148  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        LBEQ    LineDrawDot1_HIG148    ; If zero then go SET one single pixel
...
!       LDD     endX
        ...
        LBLS    LineNotHorizontal_HIG148  ; If the size is <= 16 then go draw the line normally
