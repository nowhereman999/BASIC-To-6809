...
; Test for a horizontal line
        ...
        LBNE    LineNotHorizontal_HIG123  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        LBEQ    LineDrawDot1_HIG123    ; If zero then go PSET one single pixel
...
!       LDB     endX+1
        ...
        LBLS    LineNotHorizontal_HIG123  ; If the size is <= 16 then go draw the line normally
