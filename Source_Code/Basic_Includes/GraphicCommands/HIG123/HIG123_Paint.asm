...
PaintWhileLoop1_HIG123:           ; Start of WHILE/WEND loop
        ...
        LBEQ    PaintWend_01_HIG123    ; If Equal, then jump to the end of the WHILE/WEND loop
...
PaintWhileLoop3_HIG123                ; Start of WHILE/WEND loop
        ...
        LBHS    PaintWend_03_HIG123   ; If the result is a false then goto the end of the WHILE/WEND loop
        ...
        LBNE    PaintWend_03_HIG123  ; If they are not equal then goto the end of the WHILE/WEND loop
