...
DrawDestination         FCB     96,40         ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     96,40         ; y,x co-ordinates of the Draw Start
...
NoUpdateStart:
        LDY     #LINE_HIG106    ; Y points at the routine to draw the line
