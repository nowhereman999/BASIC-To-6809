; Graphics commands for screen mode HIG106
; Resolution of 80x192x4 colours
ScreenWidth_HIG106    EQU 80
ScreenHeight_HIG106   EQU 192
BytesPerRow_HIG106    EQU ScreenWidth_HIG106/4
Screen_Size_HIG106    EQU $0F00
;
; Do SET
; Enter with:
...
DoSet_HIG106:
        ...
        LDX     #PixelTable0_HIG106 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG106 ; U points to the table of pixel values
        LSLB
...
POINT_HIG106:
        ...
        LDX     #PixelTableClear_HIG106 ; X points to the table of pixel values
...
GCLS_HIG106:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG106,X ; Screen Size
        STU     GCLSComp_HIG106+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
