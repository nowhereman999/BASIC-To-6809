...
CIRCLE_HIG155:
        ...
        LDD     #DoReSetYXCheck_HIG155 ; Get address of RESET for black pixels
        BRA     >
@Colour1:
        LDD     #DoSetYXCheck_HIG155 ; Get address of SET for white pixels
!       STD     SelfModC1_HIG155+1 ; Selfmod the jump address
        STD     SelfModC2_HIG155+1 ; Selfmod the jump address
        STD     SelfModC3_HIG155+1 ; Selfmod the jump address
        STD     SelfModC4_HIG155+1 ; Selfmod the jump address
        STD     SelfModC5_HIG155+1 ; Selfmod the jump address
        STD     SelfModC6_HIG155+1 ; Selfmod the jump address
        STD     SelfModC7_HIG155+1 ; Selfmod the jump address
        STD     SelfModC8_HIG155+1 ; Selfmod the jump address
...
; decision= decision+ 4 * (x - y) + 10
        ...
        ADDD    decision
        STD     decision
        BRA     CircleLoop_HIG155          ; Loop until x <= y
; else:
...
; Plot (y + x_Center, x + y_Center)
        ...
        LDX     x0
        LDD     #CircleScale_HIG155     ; Scale factor
        PSHS    D,X
...
!	    CMPX    #ScreenWidth_HIG155-1 ; are we screen edge or less
        BLE     @GoodX	; if so we are good as is
        LDX     #ScreenWidth_HIG155-1	; otherwise make it screen edge
@GoodX  JMP     RESET_HIG155    ; go set the pixel
