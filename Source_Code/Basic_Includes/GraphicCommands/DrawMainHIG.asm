...
;Doing a relative move
        ...
        JSR     DrawLineScale4  ; Go scale the line scaled version is saved in DrawDestination (y & x co-ordinates)
...
; Do the Up command
DrawU4:
        JSR     GetNumberinDrawCommand   ; Get the number from the string in D (actually only need value in B)
        TSTB
