...
CIRCLE_HIG139:
        ...
        LDD     #DoReSetYXCheck_HIG139 ; Get address of RESET for black pixels
        BRA     >
@Colour1:
        LDD     #DoSetYXCheck_HIG139 ; Get address of SET for white pixels
!       STD     SelfModC1_HIG139+1 ; Selfmod the jump address
        STD     SelfModC2_HIG139+1 ; Selfmod the jump address
        STD     SelfModC3_HIG139+1 ; Selfmod the jump address
        STD     SelfModC4_HIG139+1 ; Selfmod the jump address
        STD     SelfModC5_HIG139+1 ; Selfmod the jump address
        STD     SelfModC6_HIG139+1 ; Selfmod the jump address
        STD     SelfModC7_HIG139+1 ; Selfmod the jump address
        STD     SelfModC8_HIG139+1 ; Selfmod the jump address
...
; decision= decision+ 4 * (x - y) + 10
        ...
        ADDD    decision
        STD     decision
        BRA     CircleLoop_HIG139          ; Loop until x <= y
; else:
...
!	    CMPX    #ScreenWidth_HIG139-1 ; are we screen edge or less
        BLE     @GoodX	; if so we are good as is
        LDX     #ScreenWidth_HIG139-1	; otherwise make it screen edge
@GoodX  JMP     RESET_HIG139    ; go set the pixel
