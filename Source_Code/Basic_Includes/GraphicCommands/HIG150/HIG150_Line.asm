...
; Test for a horizontal line
        ...
        BNE     LineNotHorizontal_HIG150  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        BEQ     LineDrawDot1_HIG150    ; If zero then go SET one single pixel
...
!       LDD     endX
        ...
        BLS     LineNotHorizontal_HIG150  ; If the size is <= 16 then go draw the line normally
