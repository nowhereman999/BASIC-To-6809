; Graphics commands for screen mode HIG119
; Resolution of 128x200x16 colours
ScreenWidth_HIG119    EQU 128
ScreenHeight_HIG119   EQU 200
BytesPerRow_HIG119    EQU ScreenWidth_HIG119/2
Screen_Size_HIG119    EQU $3200
;
; Do SET
; Enter with:
...
DoSet_HIG119:
        ...
        LDB     1,S
        ANDB    #%00000001
        BNE     SetOddPixel_HIG119 ; Go colour the Odd Pixel
; Set the even pixel
        LDA     #%00001111
...
GCLS_HIG119:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG119,X ; Screen Size
        STU     GCLSComp_HIG119+1 ; Self mod end address
        ANDB    #%00001111
        PSHS    B  
        LSLB
        LSLB
