...
; Test for a horizontal line
        ...
        LBNE    LineNotHorizontal_HIG125  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        LBEQ    LineDrawDot1_HIG125    ; If zero then go SET one single pixel
...
!       LDB     endX+1
        ...
        LBLS    LineNotHorizontal_HIG125  ; If the size is <= 8 then go draw the line normally
