...
DrawDestination         FCB     100,80        ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     100,80        ; y,x co-ordinates of the Draw Start
...
DrawHIG125:
        ...
        LDY     #LINE_HIG125    ; Y points at the routine to draw the line
