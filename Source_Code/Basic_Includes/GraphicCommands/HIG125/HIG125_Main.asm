; Graphics commands for screen mode HIG125
; Resolution of 160x200x4 colours
ScreenWidth_HIG125    EQU 160
ScreenHeight_HIG125   EQU 200
BytesPerRow_HIG125    EQU ScreenWidth_HIG125/4
Screen_Size_HIG125    EQU $1F40
;
; Enter with:
; A = y coordinate
; B = x coordinate
...
DoSet_HIG125:
        ...
        LDX     #PixelTable0_HIG125 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG125 ; U points to the table of pixel values
        LSLB
...
POINT_HIG125:
        ...
        LDX     #PixelTableClear_HIG125 ; X points to the table of pixel values
...
GCLS_HIG125:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG125,X ; Screen Size
        STU     GCLSComp_HIG125+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
