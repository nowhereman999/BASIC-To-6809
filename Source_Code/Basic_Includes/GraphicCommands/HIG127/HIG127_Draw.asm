...
DrawDestination         FCB     96,80         ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     96,80         ; y,x co-ordinates of the Draw Start
...
DrawHIG127:
        ...
        LDY     #LINE_HIG127    ; Y points at the routine to draw the line
