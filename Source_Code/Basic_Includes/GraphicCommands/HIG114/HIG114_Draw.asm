...
DrawDestination         FCB     112,64        ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     112,64        ; y,x co-ordinates of the Draw Start
...
DrawHIG114:
        ...
        LDY     #LINE_HIG114    ; Y points at the routine to draw the line
