...
Character_Blank:
        LDA     #%11111111
        STA     ,U                      * 0
        STA     BytesPerRow_HIG132,U      * 1
        STA     BytesPerRow_HIG132*2,U    * 2
        LEAU    BytesPerRow_HIG132*6,U
        STA     -BytesPerRow_HIG132*3,U   * 3
        STA     -BytesPerRow_HIG132*2,U   * 4
        STA     -BytesPerRow_HIG132,U     * 5
        STA     ,U                      * 6
        STA     BytesPerRow_HIG132,U      * 7
        STA     BytesPerRow_HIG132*2,U    * 8
        STA     BytesPerRow_HIG132*3,U    * 9
        RTS
; **************************************
; !
;0 11111111
...
Character_Exclamation:
        LDA     #%11111111
        STA     ,U                      * 0
        LEAU    BytesPerRow_HIG132*5,U
        STA     BytesPerRow_HIG132,U      * 6
        STA     BytesPerRow_HIG132*3,U    * 8
        STA     BytesPerRow_HIG132*4,U    * 9
        LDA     #%11110111
        STA     -BytesPerRow_HIG132*4,U   * 1
        STA     -BytesPerRow_HIG132*3,U   * 2
        STA     -BytesPerRow_HIG132*2,U   * 3
        STA     -BytesPerRow_HIG132,U     * 4
        STA     ,U                      * 5
        STA     BytesPerRow_HIG132*2,U    * 7
        RTS
; **************************************
; "
;0 11111111
...
Character_Quote:
        LDA     #%11111111
        STA     ,U     * 0
        LEAU    BytesPerRow_HIG132*4,U
        STA     ,U     * 4      U
        STA     BytesPerRow_HIG132,U   * 5
        STA     BytesPerRow_HIG132*2,U   * 6
        STA     BytesPerRow_HIG132*3,U   * 7
        STA     BytesPerRow_HIG132*4,U   * 8
        STA     BytesPerRow_HIG132*5,U   * 9
        LDA     #%11101011
        STA     -BytesPerRow_HIG132*3,U  * 1
        STA     -BytesPerRow_HIG132*2,U  * 2
        STA     -BytesPerRow_HIG132,U  * 3
        RTS
; **************************************
; #
;0 11111111
