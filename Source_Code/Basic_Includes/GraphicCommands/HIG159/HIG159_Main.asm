; Graphics commands for screen mode HIG159
; Resolution of 640x225x4 colours
ScreenWidth_HIG159    EQU 640
ScreenHeight_HIG159   EQU 225
BytesPerRow_HIG159    EQU ScreenWidth_HIG159/4
Screen_Size_HIG159    EQU $8CA0
;
; Enter with:
; A = y coordinate
; X = x coordinate
...
DoSet_HIG159:
        ...
        LDX     #PixelTable0_HIG159 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG159 ; U points to the table of pixel values
        LSLB
...
POINT_HIG159:
        ...
        LDU     #PixelTableClear_HIG159 ; U points to the table of pixel values
...
GCLS_HIG159:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG159,X ; Screen Size
        STU     GCLSComp_HIG159+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
