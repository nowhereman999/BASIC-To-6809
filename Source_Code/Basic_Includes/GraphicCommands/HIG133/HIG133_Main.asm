; Graphics commands for screen mode HIG133
; Resolution of 256x192x4 colours
ScreenWidth_HIG133    EQU 256
ScreenHeight_HIG133   EQU 192
BytesPerRow_HIG133    EQU ScreenWidth_HIG133/4
Screen_Size_HIG133    EQU $3000
;
; Enter with:
; A = y coordinate
; B = x coordinate
...
DoSet_HIG133:
        ...
        LDX     #PixelTable0_HIG133 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG133 ; U points to the table of pixel values
        LSLB
...
POINT_HIG133:
        ...
        LDX     #PixelTableClear_HIG133 ; X points to the table of pixel values
...
GCLS_HIG133:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG133,X ; Screen Size
        STU     GCLSComp_HIG133+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
