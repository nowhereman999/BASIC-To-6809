; Graphics commands for screen mode HIG126
; Resolution of 160x225x4 colours
ScreenWidth_HIG126    EQU 160
ScreenHeight_HIG126   EQU 225
BytesPerRow_HIG126    EQU ScreenWidth_HIG126/4
Screen_Size_HIG126    EQU $2328
;
; Enter with:
; A = y coordinate
; B = x coordinate
...
DoSet_HIG126:
        ...
        LDX     #PixelTable0_HIG126 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG126 ; U points to the table of pixel values
        LSLB
...
POINT_HIG126:
        ...
        LDX     #PixelTableClear_HIG126 ; X points to the table of pixel values
...
GCLS_HIG126:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG126,X ; Screen Size
        STU     GCLSComp_HIG126+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
