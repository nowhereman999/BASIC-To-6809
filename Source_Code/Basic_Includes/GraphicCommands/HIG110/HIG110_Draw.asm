...
DrawDestination         FCB     100,40        ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     100,40        ; y,x co-ordinates of the Draw Start
...
NoUpdateStart:
        LDY     #LINE_HIG110    ; Y points at the routine to draw the line
