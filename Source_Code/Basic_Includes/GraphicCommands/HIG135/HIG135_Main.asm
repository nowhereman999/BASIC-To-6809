; Graphics commands for screen mode HIG135
; Resolution of 256x225x4 colours
ScreenWidth_HIG135    EQU 256
ScreenHeight_HIG135   EQU 225
BytesPerRow_HIG135    EQU ScreenWidth_HIG135/4
Screen_Size_HIG135    EQU $3840
;
; Enter with:
; A = y coordinate
; B = x coordinate
...
DoSet_HIG135:
        ...
        LDX     #PixelTable0_HIG135 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG135 ; U points to the table of pixel values
        LSLB
...
POINT_HIG135:
        ...
        LDX     #PixelTableClear_HIG135 ; X points to the table of pixel values
...
GCLS_HIG135:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG135,X ; Screen Size
        STU     GCLSComp_HIG135+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
