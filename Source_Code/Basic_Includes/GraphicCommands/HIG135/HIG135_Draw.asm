...
DrawDestination         FCB     112,128       ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     112,128       ; y,x co-ordinates of the Draw Start
...
DrawHIG135:
        ...
        LDY     #LINE_HIG135    ; Y points at the routine to draw the line
