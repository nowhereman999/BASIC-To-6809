; Graphics commands for screen mode HIG142
; Resolution of 320x192x4 colours
ScreenWidth_HIG142    EQU 320
ScreenHeight_HIG142   EQU 192
BytesPerRow_HIG142    EQU ScreenWidth_HIG142/4
Screen_Size_HIG142    EQU $3C00
;
; Enter with:
; A = y coordinate
; X = x coordinate
...
DoSet_HIG142:
        ...
        LDB     #BytesPerRow_HIG142 ; MUL A by the number of bytes per row
        MUL      
        ...
        LDX     #PixelTable0_HIG142 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG142 ; U points to the table of pixel values
        LSLB
...
POINT_HIG142:
        ...
        LDU     #PixelTableClear_HIG142 ; U points to the table of pixel values
...
GCLS_HIG142:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG142,X ; Screen Size
        STU     GCLSComp_HIG142+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
