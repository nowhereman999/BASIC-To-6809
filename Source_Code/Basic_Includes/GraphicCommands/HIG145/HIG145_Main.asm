; Graphics commands for screen mode HIG145
; Resolution of 320x192x16 colours
ScreenWidth_HIG145    EQU 320
ScreenHeight_HIG145   EQU 192
BytesPerRow_HIG145    EQU ScreenWidth_HIG145/2
Screen_Size_HIG145    EQU $7800
;
; Enter with:
; A = y coordinate
; X = x coordinate
...
DoSet_HIG145:
        ...
        LDB     1,S
        ANDB    #%00000001
        BNE     SetOddPixel_HIG145 ; Go colour the Odd Pixel
; Set the even pixel
        LDA     #%00001111
...
BoxSet_HIG145:
        ...
        LDB     2,S
        ANDB    #%00000001
        BNE     BoxSetOdd_HIG145 ; Go colour the Odd Pixel
; Set the even pixel
        LDA     #%00001111
        ANDA    ,X              ; Get the odd pixel value on screen
        STA     ,X              ; Save only the odd pixel on screen
...
POINT_HIG145:
        ...
        ANDA    #%00000001
        BNE     GetOddPixel_HIG145 ; Go get the colour the Odd Pixel
; Get the even pixel
        LSRB
        LSRB
        LSRB
...
GCLS_HIG145:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG145,X ; Screen Size
        STU     GCLSComp_HIG145+1 ; Self mod end address
