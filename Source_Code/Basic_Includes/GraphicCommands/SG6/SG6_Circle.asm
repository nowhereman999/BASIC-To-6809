...
CircleScale_SG6     EQU 80              ; 64 too tall   ; 32 is way too tall  ; 96 not tall enough
;
...
CIRCLE_SG6:
        ...
        STA     C_SG6           ; Save the colour for the circle command to use
        CLRA
...
;   decision= decision+ 4 * (x - y) + 10
        ...
        BRA     CircleLoop_SG6          ; Loop until x <= y
;        else:
...
PlotPoints_SG6:
        ...
        LDA     y0+1
        ADDA    y_Center+1
        BSR     DoSetYXCheck_SG6            ; Plot the pixel
        ; Plot (-x + x_Center, y + y_Center)
        LDB     x_Center+1
        SUBB    x0+1
        LDA     y0+1
