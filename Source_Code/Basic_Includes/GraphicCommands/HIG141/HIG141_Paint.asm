...
PaintWhileLoop1_HIG141:           ; Start of WHILE/WEND loop
        ...
        LBEQ    PaintWend_01_HIG141    ; If Equal, then jump to the end of the WHILE/WEND loop
...
PaintWhileLoop3_HIG141                ; Start of WHILE/WEND loop
        ...
        LBHS    PaintWend_03_HIG141   ; If the result is a false then goto the end of the WHILE/WEND loop
        ...
        LBNE    PaintWend_03_HIG141  ; If they are not equal then goto the end of the WHILE/WEND loop
