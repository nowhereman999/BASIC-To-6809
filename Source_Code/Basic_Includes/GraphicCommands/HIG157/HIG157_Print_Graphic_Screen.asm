...
BytesPerChar    EQU     2
PRINT_D_Graphics_Screen_HIG157:
...
!       LDA     _Var_PF04
        ...
        BSR     AtoGraphics_Screen_HIG157
        LDA     #$20        ; Blank
        BRA     AtoGraphics_Screen_HIG157 ; Print A on the screen and return, Done
@Print1000sGScreen:
        LDA     _Var_PF01
        ADDA    #$30
        BSR     AtoGraphics_Screen_HIG157
...
@Print1sGScreen:
        ...
        BSR     AtoGraphics_Screen_HIG157
        LDA     #$20        ; Blank
        BRA     AtoGraphics_Screen_HIG157 ; Print A on the screen and return

AtoGraphics_Screen_HIG157:
...
!       LDU   BEGGRP    ; U = screen start
        LEAU  Screen_Size_HIG157-(FontHeight-1)*BytesPerRow_HIG157,U      ; U = screen End - 7 rows
        PSHS  U         ; Save the value on the stack
        CMPX  ,S++      ; Compare X with the value on the stack, fix the stack
        BLO   >
        LDX   BEGGRP    ; X = Screen Start
        LEAX  Screen_Size_HIG157-BytesPerRow_HIG157*FontHeight,X  ; X = Screen Start + screen size - 1 row = bottom of the screen
        STX   GraphicCURPOS
!       CMPA  #$0D      ; Enter Key?
...
!       CMPB    #96             ; Is it a printable character?
        BLO     >               ; Yes, skip ahead
        CLRB                    ; Otherwise, make it a space
!       LDX     #CharJumpTable_HIG157 ; Get the address of the character jump table
