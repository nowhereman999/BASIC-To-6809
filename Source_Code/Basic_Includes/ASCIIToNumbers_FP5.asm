; Convert ascii text number to FP5 format
; ============================================================
...
;  Out: pushes 5-byte FP5 on stack (A,X)  [ ,S = sign/exp, 1,S..2,S = mantissa ]
;       X advanced to first non-parsed char (terminator, space, etc.)
;
;  Uses: U32_To_FP5, FP5_DIV, FP5_ADD
...
@HAVE_SOMETHING:
; ============================================================
; Convert integer part to FP5 -> A2F_TMP_INT (5 bytes)
; ============================================================
        ...
        LDD     A2F_INT_HI
        PSHS    D
        JSR     U32_To_FP5          ; leaves 5-byte FP5 at ,S
        PULS    A,X,U
        STA     A2F_TMP_INT
        STX     A2F_TMP_INT+1
        STU     A2F_TMP_INT+3
...
@DO_FRAC:
; ============================================================
; Convert frac accumulator to FP5 -> A2F_TMP_FRACINT
; ============================================================
        LDD     A2F_FRAC_LO
        PSHS    D
        LDD     A2F_FRAC_HI
        ...
        STU     A2F_TMP_FRACINT+3
; ============================================================
; pow10 = 10^fracDigits (U32), convert to FP5 -> A2F_TMP_POW
; ============================================================
        LDB     A2F_FRACDIG         ; 0..9
        LDX     #Pow10_U32_Table
        ; offset = B*4
        ...
        STU     A2F_TMP_POW+3
; ============================================================
; fracFP5 = fracIntFP5 / powFP5
;   stack order for FP5_DIV: value1 at 5,S, value2 at ,S
;   => push fracInt first, then pow
; ============================================================
        LDA     A2F_TMP_FRACINT
        LDX     A2F_TMP_FRACINT+1
        LDU     A2F_TMP_FRACINT+3
        PSHS    A,X,U               ; fracInt
        LDA     A2F_TMP_POW
        LDX     A2F_TMP_POW+1
        LDU     A2F_TMP_POW+3
        PSHS    A,X,U               ; pow
        JSR     FP5_DIV             ; result frac at ,S
        PULS    A,X,U
        STA     A2F_TMP_FRAC
        STX     A2F_TMP_FRAC+1
        STU     A2F_TMP_FRAC+3
; ============================================================
; result = int + frac
; stack order for FP5_ADD: value1 at 5,S, value2 at ,S
...
; A2F_DIGIT must exist already (you already have it in your ASCII_To_FP5 code)
ASCII_To_S32_IntPart_Stack:
