...
!       LDA     _Var_PF04
        ...
        BSR     AtoGraphics_Screen_FG6C
        LDA     #$20        ; Blank
        BRA     AtoGraphics_Screen_FG6C ; Print A on the screen and return, Done
@Print1000sGScreen:
        LDA     _Var_PF01
        ADDA    #$30
        BSR     AtoGraphics_Screen_FG6C
...
!       LDU   BEGGRP    ; U = screen start
        LEAU  Screen_Size_FG6C-(FontHeight-1)*BytesPerRow_FG6C,U      ; U = screen End - 7 rows
...
!       CMPB    #96             ; Is it a printable character?
        BLO     >               ; Yes, skip ahead
        CLRB                    ; Otherwise, make it a space
!       LDX     #CharJumpTable_FG6C ; Get the address of the character jump table
