...
Character_Ampersand:
        ...
        STD     -BytesPerRow_HIG142*3,U  * 1
        STD     ,U     * 4      U
        LDD     #%0110011001010101
        STD     -BytesPerRow_HIG142*2,U  * 2
        LDD     #%0110011001010101
        STD     -BytesPerRow_HIG142,U  * 3
        LDD     #%0110011001100101
        STD     BytesPerRow_HIG142,U   * 5
        LDD     #%0110010110010101
        STD     BytesPerRow_HIG142*2,U   * 6
        LDD     #%0101101001100101
        STD     BytesPerRow_HIG142*3,U   * 7
        RTS
; **************************************
; '
