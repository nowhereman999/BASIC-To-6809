...
Character_Blank:
        ...
        STD     ,U
        STD     2,U    * 0
        LEAU    BytesPerRow_HIG138*4,U
        STD     -BytesPerRow_HIG138*3,U
        STD     -BytesPerRow_HIG138*3+2,U  * 1
        STD     -BytesPerRow_HIG138*2,U
        STD     -BytesPerRow_HIG138*2+2,U  * 2
        STD     -BytesPerRow_HIG138,U
        STD     -BytesPerRow_HIG138+2,U  * 3
        STD     ,U
        STD     2,U    * 4
        STD     BytesPerRow_HIG138,U
        STD     BytesPerRow_HIG138+2,U   * 5
        STD     BytesPerRow_HIG138*2,U
        STD     BytesPerRow_HIG138*2+2,U   * 6
        STD     BytesPerRow_HIG138*3,U
        STD     BytesPerRow_HIG138*3+2,U   * 7
        RTS
; **************************************
; !
;0 0000000000000000 0000000000000000
...
Character_Exclamation:
        ...
        STD     2,U    * 0B
        LEAU    BytesPerRow_HIG138*4,U
        STD     -BytesPerRow_HIG138*3,U    * 1A
        STD     -BytesPerRow_HIG138*2,U    * 2A
        STD     BytesPerRow_HIG138+2,U     * 5B
        STD     BytesPerRow_HIG138*2,U     * 6A
        STD     BytesPerRow_HIG138*2+2,U   * 6B
        STD     BytesPerRow_HIG138*3+2,U   * 7B
        LDD     #%0001000100010000
        STD     -BytesPerRow_HIG138*3+2,U  * 1B
        STD     -BytesPerRow_HIG138*2+2,U  * 2B
        LDD     #%0000000000000001
        STD     -BytesPerRow_HIG138,U      * 3A
        STD     ,U                         * 4A
        STD     BytesPerRow_HIG138,U       * 5A
        LDD     #%0001000100000000
        STD     -BytesPerRow_HIG138+2,U    * 3B
        LDD     #%0001000000000000
        STD     2,U                        * 4B
        LDD     #%0000000000010000
        STD     BytesPerRow_HIG138*3,U     * 7A
        RTS
; **************************************
; "
;0 0000000000000000 0000000000000000
