...
DrawDestination         FCB     100,128       ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     100,128       ; y,x co-ordinates of the Draw Start
...
NoUpdateStart:
        LDY     #LINE_HIG131    ; Y points at the routine to draw the line
