; Graphics commands for screen mode HIG107
; Resolution of 80x200x4 colours
ScreenWidth_HIG107    EQU 80
ScreenHeight_HIG107   EQU 200
BytesPerRow_HIG107    EQU ScreenWidth_HIG107/4
Screen_Size_HIG107    EQU $0FA0
;
; Do SET
; Enter with:
...
DoSet_HIG107:
        ...
        LDX     #PixelTable0_HIG107 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG107 ; U points to the table of pixel values
        LSLB
...
POINT_HIG107:
        ...
        LDX     #PixelTableClear_HIG107 ; X points to the table of pixel values
...
GCLS_HIG107:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG107,X ; Screen Size
        STU     GCLSComp_HIG107+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
