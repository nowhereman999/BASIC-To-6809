; Graphics commands for screen mode FG2C
; Resolution of 128x64x4 colours
ScreenWidth_FG2C    EQU 128
ScreenHeight_FG2C   EQU 64
BytesPerRow_FG2C    EQU ScreenWidth_FG2C/4
Screen_Size_FG2C    EQU $0800
; A=y value, B=x value
* SET command
SET_FG2C:
DoSet_FG2C:
...
!       LSRA
        ...
        LDX     #PixelTable0_FG2C ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_FG2C ; U points to the table of pixel values
        LSLB
...
!       LSRA
        ...
        LDX     #PixelTableClear_FG2C ; X points to the table of pixel values
...
GCLS_FG2C:
        LDX     BEGGRP
        LEAU    Screen_Size_FG2C,X ; Screen Size
        STU     GCLSComp_FG2C+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
