...
DrawDestination         FCB     112,32         ; y,x co-ordinates of the Draw Destination
DrawStart               FCB     112,32         ; y,x co-ordinates of the Draw Start
...
NoUpdateStart:
        LDY     #LINE_HIG102    ; Y points at the routine to draw the line
