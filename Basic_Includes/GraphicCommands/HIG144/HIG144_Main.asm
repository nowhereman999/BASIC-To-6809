; Graphics commands for screen mode HIG144
; Resolution of 320x225x4 colours
ScreenWidth_HIG144    EQU 320
ScreenHeight_HIG144   EQU 225
BytesPerRow_HIG144    EQU ScreenWidth_HIG144/4
Screen_Size_HIG144    EQU $4650
;
; Enter with:
; A = y coordinate
; X = x coordinate
...
DoSet_HIG144:
        ...
        LDX     #PixelTable0_HIG144 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG144 ; U points to the table of pixel values
        LSLB
...
POINT_HIG144:
        ...
        LDU     #PixelTableClear_HIG144 ; U points to the table of pixel values
...
GCLS_HIG144:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG144,X ; Screen Size
        STU     GCLSComp_HIG144+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
