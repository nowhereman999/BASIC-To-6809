; Graphics commands for screen mode HIG116
; Resolution of 128x200x4 colours
ScreenWidth_HIG116    EQU 128
ScreenHeight_HIG116   EQU 200
BytesPerRow_HIG116    EQU ScreenWidth_HIG116/4
Screen_Size_HIG116    EQU $1900
; Do SET
; Enter with:
...
DoSet_HIG116:
        ...
        LDX     #PixelTable0_HIG116 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG116 ; U points to the table of pixel values
        LSLB
...
POINT_HIG116:
        ...
        LDX     #PixelTableClear_HIG116 ; X points to the table of pixel values
...
GCLS_HIG116:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG116,X ; Screen Size
        STU     GCLSComp_HIG116+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
