...
; Test for a horizontal line
        ...
        BNE     LineNotHorizontal_HIG116  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        BEQ     LineDrawDot1_HIG116    ; If zero then go SET one single pixel
...
!       LDB     endX+1
        ...
        BLS     LineNotHorizontal_HIG116  ; If the size is <= 8 then go draw the line normally
