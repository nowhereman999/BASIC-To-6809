...
; decision= decision+ 4 * (x - y) + 10
        ...
        ADDD    decision
        STD     decision
        BRA     CircleLoop_HIG153          ; Loop until x <= y
; else:
...
; Plot (x + x_Center, y + y_Center)
        ...
        TFR     D,X
        LDA     y0+1
        LDB     #CircleScale_HIG153
        MUL
        ADDA    y_Center+1
        BSR     DoSetYXCheck_HIG153              ; Plot the pixel
; Plot (-x + x_Center, y + y_Center)
        LDD     x_Center
        SUBD    x0
        TFR     D,X
...
; Plot (y + x_Center, x + y_Center)
        ...
        LDX     x0
        LDD     #CircleScale_HIG153     ; Scale factor
        PSHS    D,X
        JSR     MUL16           ; D = D * X
...
; Plot (-y + x_Center, x + y_Center)
        ...
        ADDA    y_Center+1
        PULS    X               ; restore x value
        JSR     DoSetYXCheck_HIG153      ; Plot the pixel
; Plot (y + x_Center, -x + y_Center)
        LDD     y0
        ADDD    x_Center
        PSHS    D               ; save the x value
