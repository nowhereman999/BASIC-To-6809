...
PaintWhileLoop1_HIG100:           ; Start of WHILE/WEND loop
        ...
        BEQ     PaintWend_01_HIG100    ; If Equal, then jump to the end of the WHILE/WEND loop
...
PaintWhileLoop3_HIG100                ; Start of WHILE/WEND loop
        ...
        BHS     PaintWend_03_HIG100   ; If the result is a false then goto the end of the WHILE/WEND loop
        ...
        BNE     PaintWend_03_HIG100  ; If they are not equal then goto the end of the WHILE/WEND loop
