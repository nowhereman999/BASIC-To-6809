; Graphics commands for screen mode HIG108
; Resolution of 80x225x4 colours
ScreenWidth_HIG108    EQU 80
ScreenHeight_HIG108   EQU 225
BytesPerRow_HIG108    EQU ScreenWidth_HIG108/4
Screen_Size_HIG108    EQU $1194
;
; Do SET
; Enter with:
...
DoSet_HIG108:
        ...
        LDX     #PixelTable0_HIG108 ; U points to the table of pixels to erase
        ANDA    B,X             ; Clear out the our pixel
        LDX     #PixelTable1_HIG108 ; U points to the table of pixel values
        LSLB
...
POINT_HIG108:
        ...
        LDX     #PixelTableClear_HIG108 ; X points to the table of pixel values
...
GCLS_HIG108:
        LDX     BEGGRP
        LEAU    Screen_Size_HIG108,X ; Screen Size
        STU     GCLSComp_HIG108+1 ; Self mod end address
        ANDB    #%00000011
        BEQ     @GotB
        DECB
        BNE     >
