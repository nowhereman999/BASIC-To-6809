...
; Test for a horizontal line
        ...
        BNE     LineNotHorizontal_HIG122  ; If they aren't the same then go draw a line normally
; Get the number of bytes between pixels
        ...
        BEQ     LineDrawDot1_HIG122    ; If zero then go PSET one single pixel
...
!       LDB     endX+1
        ...
        BLS     LineNotHorizontal_HIG122  ; If the size is <= 16 then go draw the line normally
