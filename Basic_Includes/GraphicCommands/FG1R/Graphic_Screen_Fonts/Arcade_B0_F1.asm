...
Character_Blank:
        ...
        STA     -BytesPerRow_FG1R*3,U  * 1      U-96
        STA     -BytesPerRow_FG1R*2,U  * 2      U-64
        STA     -BytesPerRow_FG1R,U  * 3      U-32
        STA     ,U     * 4      U
        STA     BytesPerRow_FG1R,U   * 5      U+32
        STA     BytesPerRow_FG1R*2,U   * 6      U+64
        STA     BytesPerRow_FG1R*3,U   * 7      U+96
        RTS
; **************************************
;  !
;0 00000000
