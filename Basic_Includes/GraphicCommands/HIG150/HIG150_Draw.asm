...
DrawStartY              FDB     112           ; y co-ordinate of the Draw Start
DrawStartX              FDB     256           ; x co-ordinate of the Draw Start
DrawDestinationY        FDB     112           ; y co-ordinate of the Draw Destination
DrawDestinationX        FDB     256           ; x co-ordinate of the Draw Destination
...
NoUpdateStart:
        LDY     #LINE_HIG150    ; Y points at the routine to draw the line
